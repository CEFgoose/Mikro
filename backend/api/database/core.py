...
class Project(ModelWithSoftDeleteAndCRUD, SurrogatePK):
    ...
    max_payment = db.Column(db.Integer, nullable=False, default=0)
    payment_due = db.Column(db.Integer, nullable=False, default=0)
    total_payout = db.Column(db.Integer, nullable=False, default=0)
    rate_per_task = db.Column(db.Integer, nullable=False, default=100)
